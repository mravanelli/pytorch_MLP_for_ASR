...
set noxtics
set noytics
set title 'DET plot for ../TIMIT_MLP_fmllr/decoding_test/score_5/ctm_39phn.filt'
set nokey
...
plot [-3.290527:3.290527] [-3.290527:3.290527] \
 "../TIMIT_MLP_fmllr/decoding_test/score_5/ctm_39phn.filt.det.dat.00" using 2:1 title "../TIMIT_MLP_fmllr/decoding_test/score_5/ctm_39phn" with lines 1
set ytics
set xtics
set size 1.0, 1.0
set key
